...
/**
 * This class executes the test case T400RealLE with the Yices solver.
 * 
 * 1. X0 <= 0
 * 2. X0 <= 0 OR X1 <= 0
 * 3. X0 <= 0 OR X1 <= 0 OR X2 <= 0
 * 4. .....
 * 
 * @author dinh
 * 
 */
public class T400YicesRealLE {
	...
	/**
	 * This method executes a test case T400RealLE.
	 * 
	 * @param solver
	 *            a Yices solver
	 * @param repeats
