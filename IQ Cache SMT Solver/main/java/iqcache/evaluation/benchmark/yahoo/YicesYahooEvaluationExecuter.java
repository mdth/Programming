 ...
 * @author dinh
 */
public class YicesYahooEvaluationExecuter {

	// changeable information
	private static final String BENCHMARK = EvaluationParameters.YAHOO;

	// Yahoo benchmark data
	private static final String FILE1_1 = "C:\\Users\\foo\\workspace\\IQCache SMTSolver Evaluation Scripts\\monarch3\\semanticcache-t2500-s2.txt";
