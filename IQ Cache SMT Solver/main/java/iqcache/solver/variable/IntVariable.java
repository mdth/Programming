...
/**
 * An abstract variable of type int. This type does not have a size.
 * 
 * @author $LastChangedBy: ehlers $
 * @version $Revision: 2919 $
 * @version $LastChangedDate: 2013-04-26 14:12:54 +0200 (Fri, 26 Apr 2013) $
 */
public abstract class IntVariable extends AbstractVariable {
	 ...
	 */
	public IntVariable(Column column) {
		super(column);
	}
